                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-primary btn-sm"
                                                    onclick="update(`{{ $d['id'] }}`, `{{ $d['nama'] }}`, `{{ $d['angkatan_id'] }}`)">
                                                    <i class="fa fa-pencil"></i> Update
                                                </button>
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ base_url }}kelas_siswa?id={{ $d['id'] }}">
                                                    <i class="fa fa-info-circle"></i> Siswa
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
...
@push('scripts')
    <script>
        ...
        // Update button click
        let update = (id, name, angkatan_id) => {
            postType = 'update'
            $('#id').val(id)
            $('input[name="nama"]').val(name)
            $('select[name="angkatan_id"]').val(angkatan_id).change()
        ...
        $(() => {
            ...
            $('#form').submit(ev => {
                ...
                let url = postType == 'create' ?
                    '{{ base_url }}kelas/insert' :
                    '{{ base_url }}kelas/update';
